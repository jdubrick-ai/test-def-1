...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-def-1](https://github.com/jdubrick-ai/test-def-1)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-def-1-gitops](https://github.com/jdubrick-ai/test-def-1-gitops)

# **Usage**

To access the test-def-1 application that was deployed using the Software Template, complete the following instructions:
